...
export default function home() {
  return (
    <div className="home">
      ...
      {/* <div id="carouselExampleInterval" className="carousel slide w-70" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active" data-bs-interval="2000">
            <img src="images/SMbanners/1.png" className="d-block w-100" alt="."></img>
          </div>
          <div className="carousel-item" data-bs-interval="2000">
            <img src="images/SMbanners/2.png" className="d-block w-100" alt="."></img>
          </div>
          <div className="carousel-item" data-bs-interval="2000">
            <img src="images/SMbanners/3.png" className="d-block w-100" alt="."></img>
          </div>
          <div className="carousel-item" data-bs-interval="2000">
            <img src="images/SMbanners/4.png" className="d-block w-100" alt="."></img>
          </div>
          <div className="carousel-item" data-bs-interval="2000">
            <img src="images/SMbanners/5.png" className="d-block w-100" alt="."></img>
          </div>
          <div className="carousel-item" data-bs-interval="2000">
            <img src="images/SMbanners/6.png" className="d-block w-100" alt="."></img>
          </div>
          <div className="carousel-item " data-bs-interval="2000">
            <img src="images/SMbanners/7.png" className="d-block w-100" alt="."></img>
          </div>
          <div className="carousel-item" data-bs-interval="2000">
            <img src="images/SMbanners/8.png" className="d-block w-100" alt="."></img>
          </div>
